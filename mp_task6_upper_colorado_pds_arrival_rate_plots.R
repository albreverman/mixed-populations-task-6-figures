...
inputFile <- "C:/Projects/MixedPopulations/TASK5/UpperColoradoRiver/UpperColoradoRiverPDSEventCountSummary_10years.csv"
outputDir <- "C:/Projects/MixedPopulations/TASK5/UpperColoradoRiver/PDS_Figures/"
